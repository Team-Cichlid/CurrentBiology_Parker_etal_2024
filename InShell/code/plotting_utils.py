...
# mom chamber colors in RGB format (reds)
# RGB_entrance= [255,247,140]
# RGB_laying= [255,198,96]
# RGB_deep= [255,112,112]

# Larvae chamber colors in RGB format (BLUES)
RGB_entrance= [56,163,165]
RGB_laying= [17,138,178]
RGB_deep= [34,87,122]

ENTRANCE_COLOR = [x / 255 for x in RGB_entrance]
LAYING_COLOR = [x / 255 for x in RGB_laying]
DEEP_COLOR = [x / 255 for x in RGB_deep]
